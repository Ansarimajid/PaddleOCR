...
DISABLE_MODEL_SOURCE_CHECK = get_flag_from_env_var("PADDLE_PDX_DISABLE_MODEL_SOURCE_CHECK", False) or get_flag_from_env_var("DISABLE_MODEL_SOURCE_CHECK", False)
